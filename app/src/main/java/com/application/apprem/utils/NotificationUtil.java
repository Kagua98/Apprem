...
import com.application.apprem.activities.MainActivity;
import com.application.apprem.models.Week;
import com.application.apprem.profiles.ProfileManagement;
import com.application.apprem.receivers.NotificationDismissButtonReceiver;
...
public class NotificationUtil {
    ...
    private static void sendNotification(@NonNull Context context, boolean alert, @Nullable NotificationCompat.Builder notificationBuilder, int id) {
        ...
        if (PreferenceUtil.isAlwaysNotification(context)) {
            ...
            mNotifyBuilder.addAction(R.drawable.ic_close, context.getString(R.string.notification_dismiss), btPendingIntent);
        }
