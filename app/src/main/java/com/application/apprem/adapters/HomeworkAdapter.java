...
public class HomeworkAdapter extends ArrayAdapter<Homework> {
    ...
    public View getView(final int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.homework_child, parent, false);
        ...
        holder.popup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ContextThemeWrapper theme = new ContextThemeWrapper(mActivity, PreferenceUtil.isDark(HomeworkAdapter.this.getContext()) ? R.style.Widget_AppCompat_PopupMenu : R.style.Widget_AppCompat_Light_PopupMenu);
